                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-secondary mb-0">
                                Update the basic details of the department.
                            </p>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                >{{ old('short_description', $department->short_description) }}</textarea>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-secondary mb-0">
                                Update the main introduction and description.
                            </p>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <input
                                    ...
                                    value="{{ old('about_heading', $department->about_heading) }}"
                            ...
                            <div class="col-12">
                                ...
                                >{{ old('about_description', $department->about_description) }}</textarea>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-secondary mb-0">
                                    Manage services provided by this department.
                                </p>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-secondary mb-0">
                                    Manage specialities handled by the department.
                                </p>
                        ...
                        <div id="specialitiesWrapper">
                            ...
                            @php
                                $specialities = old(
                                    'specialities',
                                    is_array($department->specialities)
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-secondary mb-0">
                                    Manage conditions and care areas.
                                </p>
                        ...
                        <div id="conditionsWrapper">
                            ...
                            @php
                                $conditions = old(
                                    'conditions',
                                    is_array($department->conditions)
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <input
                                    ...
                                    value="{{ old('patient_care_heading', $department->patient_care_heading) }}"
                            ...
                            <div class="col-12">
                                ...
                                >{{ old('patient_care_description', $department->patient_care_description) }}</textarea>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-secondary mb-0">
                                    Manage key reasons patients can choose this department.
                                </p>
                        ...
                        <div id="whyChooseWrapper">
                            ...
                            @php
                                $whyChoose = old(
                                    'why_choose',
                                    is_array($department->why_choose)
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <select
                                    name="doctor_ids[]"
                                    class="form-select @error('doctor_ids') is-invalid @enderror @error('doctor_ids.*') is-invalid @enderror"
                                    multiple
                                    size="6"
                                >
                                ...
                                <div class="form-text">
                                    Hold Ctrl (Windows) or Command (Mac) to select multiple doctors.
                                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (addSpeciality && specialitiesWrapper) {
        ...
        specialitiesWrapper.addEventListener(
            'click',
            function (event) {
                ...
                const rows =
                    specialitiesWrapper.querySelectorAll(
                        '.speciality-row'
                    );
    ...
    if (addCondition && conditionsWrapper) {
        ...
        conditionsWrapper.addEventListener(
            'click',
            function (event) {
                ...
                const rows =
                    conditionsWrapper.querySelectorAll(
                        '.condition-row'
                    );
    ...
    if (addWhyChoose && whyChooseWrapper) {
        ...
        whyChooseWrapper.addEventListener(
            'click',
            function (event) {
                ...
                const rows =
                    whyChooseWrapper.querySelectorAll(
                        '.why-choose-row'
                    );
