...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <form action="{{ route('admin.videos.update', $video) }}"
                  method="POST"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12 col-xl-6">
                                ...
                                <select name="language"
                                    ...
                                    <option value="Hindi"
                                        {{ old('language', $video->language) == 'Hindi' ? 'selected' : '' }}>
                                        Hindi
                                    </option>

                                    <option value="Gujarati"
                                        {{ old('language', $video->language) == 'Gujarati' ? 'selected' : '' }}>
                                        Gujarati
                                    </option>

                                    <option value="English"
                                        {{ old('language', $video->language) == 'English' ? 'selected' : '' }}>
                                        English
                                    </option>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description"
                                          ...
                                          placeholder="Enter a short description...">{{ old('description', $video->description) }}</textarea>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-secondary mb-0">
                                Update the YouTube URL and thumbnail.
                            </p>
                                ...
                                @if($video->thumbnail)
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <img src="{{ asset('storage/' . $video->thumbnail) }}"
                                             alt="{{ $video->title }}"
                                             style="width: 220px; height: 125px; object-fit: cover; border-radius: 8px;">
                                    </div>
