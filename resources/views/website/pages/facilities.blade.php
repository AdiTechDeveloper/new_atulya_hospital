                    ...
                    <div class="col-lg-4 order-2 order-xl-1">
                        ...
                        <div class="facility-sidebar sticky-style">
                            ...
                            <div class="sidebar-widget">
                                ...
                                <ul class="facility-list wow fadeInUp" data-wow-delay=".3s">
                                    ...
                                    @if ($facility->main_image)
                                        <div class="col-md-7">
                                            ...
                                            <div class="facility-image large-image wow img-custom-anim-left">
                                                ...
                                                <img src="{{ asset('storage/' . $facility->main_image) }}"
                                                    alt="{{ $facility->title }}">
                                    ...
                                    @if ($facility->secondary_image)
                                        <div class="col-md-5">
                                            ...
                                            <div class="facility-image small-image wow img-custom-anim-right">
                                                ...
                                                <img src="{{ asset('storage/' . $facility->secondary_image) }}"
                                                    alt="{{ $facility->title }}">
...
========================================= */
    ...
    .facility-section-heading {
        font-size: 25px;
        =======</div>>>>>>>>246b073f8d90c5770215b1278d6dac7dc9d7b6fd line-height: 1.4;
...
<div class="form">
    ...
    <select name="age" class="single-select w-100">
